...
(
  id SERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  parent_planet INTEGER REFERENCES planets(id)
);
...
('The Moon', 1),
('Phobos', 2), ('Deimos', 2),
('Naiad', 4), ('Thalassa', 4), ('Despina', 4), ('Galatea', 4), ('Lariss', 4),
('S/2004 N 1', 4), ('Proteus', 4), ('Triton', 4), ('Nereid', 4), ('Halimede', 4),
('Sao', 4), ('Laomedeia', 4), ('Psamathe', 4), ('Neso', 4);